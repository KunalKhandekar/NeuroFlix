...
//             text +
//             ". only give me names of 10 movies, comma seperated array like the example result given ahead. Example Result: Gadar, Sholay, Don, Golmaal, Koi Mil Gaya, ....";
...
const SuggestionPage = () => {
    ...
    const fetchData = async (text) => {
        ...
        const query =
            "Act as a Movie Recommendation system and suggest some movies for the query : " +
            text +
            ". only give me names of 10 movies, comma separated array like the example result given ahead. Example Result: Gadar, Sholay, Don, Golmaal, Koi Mil Gaya, ....";
